angular.module('eventApp').controller('formCtrl', ['eventFactory', function(eventFactory) {
    ...
    this.submitForm = function(form) {    	
        ...
        eventFactory.createEvent(angular.copy(form), this.event).then(function(data) {

             alert("Event Added Succesfully");

        }, function(error) {
            
            alert('woops! an error occurred ' +error);
        });
    }
...
.controller('eventManagerCtrl', ['eventFactory', 'initialData', function(eventFactory, initialData) { 
  // this.eventList = 
    ...
    this.eventList = initialData.data;//new refactor from abb.js resolve function
